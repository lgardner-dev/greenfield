...
Current M5 work is limited to export and target foundation vocabulary unless the user explicitly requests implementation. M5 docs may define host platform, renderer backend choice, app project, app target, build/export target, and browser-hosted WebAssembly as a future target direction. Do not add app templates, CLI behavior, install/package/export logic, Windows-specific workflows, WASM support, optional Dawn/WebGPU or FreeType behavior, or sandbox runtime changes as part of M5 vocabulary work.
